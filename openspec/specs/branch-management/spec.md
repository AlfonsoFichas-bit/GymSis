## Purpose
Permite registrar y gestionar sucursales del gimnasio con sus datos operativos (nombre, dirección, horario y capacidad) y consultar su disponibilidad en tiempo real.
